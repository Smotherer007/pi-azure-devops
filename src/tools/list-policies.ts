...
export const listPoliciesTool = {
	...
	promptSnippet: "List Azure DevOps branch/PR policies",
	promptGuidelines: [
		"Use azure_devops_list_policies to understand what checks are required before merging.",
