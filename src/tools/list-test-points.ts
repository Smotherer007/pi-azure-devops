/**
 * azure_devops_list_test_points — List test points in a suite.
 */
...
export const listTestPointsTool = {
	...
	promptGuidelines: [
		"Use azure_devops_list_test_points to see execution status per tester/configuration.",
